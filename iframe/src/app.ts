...
(function () {
	...
	function reportTitle(kind, snapshot, extra) {
		...
		if (kind === 'context') return t(`工程快照记录 · ${projectLabel}`, `Snapshot Record · ${projectLabel}`);
