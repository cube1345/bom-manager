...
1. 将顶部工具栏、工程快照和快速入口中的密集按钮改为自适应网格布局
1. 优化记录页画布工具和设置页操作区的按钮分布，降低拥挤感
1. 补充行内操作按钮的换行与宽度策略，提升窄屏和长文案场景可读性
# 1.1.18

## 变更

1. 将插件显示名称、菜单标题、关于信息与 README 统一改为物料管理助手
1. 清理 CHANGELOG 中位于 1.1.17 之前的 0.x 迭代记录，保留 1.1.x 主线日志
1. 同步更新 1.1.18 版本并重新打包扩展产物
# 1.1.17
